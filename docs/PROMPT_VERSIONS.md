...
(Extractor row measured at v8; it read 55,116 / 20,287 at v7 and 62,564 /
23,795 at v9. The share has been stable at ~27% across every bump, which is the
point — prose and schema grow together because a new field needs both.)
