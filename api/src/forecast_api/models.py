...
class ArticleDebug(BaseModel):
    url: str
    outcome: str = Field(description="ok | gate_rejected | no_predictions | subject_absent | fetch_error | gate_error | extract_error | empty_text | no_date | redirector_url | timeout")
